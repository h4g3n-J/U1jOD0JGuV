...
Public Sub BuildAuftragUebersichtSub()
    ...
    ' -> basAuftragUebersichtSub.SearchAuftragUebersicht strQueryName, strQuerySource, strPrimaryKey
    SearchAuftragUebersicht (strQueryName)
...
' Public Sub SearchAuftragUebersicht(ByVal strQueryName As String, ByVal strQuerySource As String, ByVal strPrimaryKey As String, Optional varSearchTerm As Variant = Null)
...
Public Function SelectAuftragUebersicht()
    ...
    ' show recordset
    ' referes to the textboxes in basAuftragUebersicht
